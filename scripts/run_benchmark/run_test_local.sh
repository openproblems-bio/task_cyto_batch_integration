...
nextflow run . \
  ...
  --input_train resources_test/task_cyto_batch_integration/cxg_mouse_pancreas_atlas/train.h5ad \
  --input_test resources_test/task_cyto_batch_integration/cxg_mouse_pancreas_atlas/test.h5ad \
  --input_solution resources_test/task_cyto_batch_integration/cxg_mouse_pancreas_atlas/solution.h5ad \
