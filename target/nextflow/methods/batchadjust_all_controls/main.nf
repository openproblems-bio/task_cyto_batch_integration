// batchadjust_all_controls build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/batchadjust_all_controls/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  "percentile" = $( if [ ! -z ${VIASH_PAR_PERCENTILE+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_PERCENTILE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/batchadjust_all_controls",
