// cycombine_one_control_to_mid build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "name" : "cycombine_one_control_to_mid",
  "namespace" : "methods",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/cycombine_one_control_to_mid/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "rlen" = $( if [ ! -z ${VIASH_PAR_RLEN+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_RLEN" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/cycombine_one_control_to_mid",
