// cytonorm_one_control_to_goal build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "name" : "cytonorm_one_control_to_goal",
  "namespace" : "methods",
  ...
  "label" : "CytoNorm (one-control, to-goal)",
  "summary" : "CytoNorm run with control sample from one group only, correcting to a goal batch",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/cytonorm_one_control_to_goal/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/cytonorm_one_control_to_goal",
