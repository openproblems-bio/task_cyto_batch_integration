// rpca_to_goal build_update_n_inconsistent_peak
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/rpca_to_goal/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  "npcs" = $( if [ ! -z ${VIASH_PAR_NPCS+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_NPCS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "n_neighbours" = $( if [ ! -z ${VIASH_PAR_N_NEIGHBOURS+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_N_NEIGHBOURS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/rpca_to_goal",
