// cytonorm_one_control_to_mid build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "name" : "cytonorm_one_control_to_mid",
  "namespace" : "methods",
  "version" : "build_fix_cytovi_kmeans_openblas",
  "argument_groups" : [
    {
      "name" : "Parameters",
      "arguments" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/cytonorm_one_control_to_mid/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/cytonorm_one_control_to_mid",
    "viash_version" : "0.9.4",
    "git_commit" : "d87ccddadb10dceae9a2b833bb0cb66431f2e8d2",
...
par <- list(
  "som_grid_size" = $( if [ ! -z ${VIASH_PAR_SOM_GRID_SIZE+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_SOM_GRID_SIZE" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "num_metacluster" = $( if [ ! -z ${VIASH_PAR_NUM_METACLUSTER+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_NUM_METACLUSTER" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "n_quantiles" = $( if [ ! -z ${VIASH_PAR_N_QUANTILES+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_N_QUANTILES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/cytonorm_one_control_to_mid",
    "tag" : "build_fix_cytovi_kmeans_openblas"
  },
  "label" : [
    "midtime",
    "midmem",
