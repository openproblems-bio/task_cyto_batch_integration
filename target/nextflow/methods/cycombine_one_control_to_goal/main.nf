// cycombine_one_control_to_goal build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "summary" : "cyCombine run with control sample from one group only, correcting to a goal batch",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/methods/cycombine_one_control_to_goal/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/methods/cycombine_one_control_to_goal",
