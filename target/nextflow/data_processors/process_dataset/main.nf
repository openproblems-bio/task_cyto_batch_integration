// process_dataset build_fix_cytovi_kmeans_openblas
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/data_processors/process_dataset/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'output_censored_split1': $( if [ ! -z ${VIASH_PAR_OUTPUT_CENSORED_SPLIT1+x} ]; then echo "r'${VIASH_PAR_OUTPUT_CENSORED_SPLIT1//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_censored_split2': $( if [ ! -z ${VIASH_PAR_OUTPUT_CENSORED_SPLIT2+x} ]; then echo "r'${VIASH_PAR_OUTPUT_CENSORED_SPLIT2//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/data_processors/process_dataset",
