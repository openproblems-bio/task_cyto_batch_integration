// lisi build_update_n_inconsistent_peak
// 
...
meta = [
    ...
    "metrics" : [
      {
        ...
        "description" : "Compute the integration local inverse simpson index (iLISI) for each cell, then return the median \nas the final score. \n",
        "references" : {
          "doi" : [
      ...
      },
      {
        ...
        "description" : "Compute the cell type local inverse simpson index (cLISI) for each cell, then return the median \nas the final score. \n",
        "references" : {
          "doi" : [
            "10.1038/s41592-019-0619-0"
          ],
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/metrics/lisi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/metrics/lisi",
