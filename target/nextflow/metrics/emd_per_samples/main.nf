...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/metrics/emd_per_samples/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'samples_to_compare': $( if [ ! -z ${VIASH_PAR_SAMPLES_TO_COMPARE+x} ]; then echo "r'${VIASH_PAR_SAMPLES_TO_COMPARE//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/metrics/emd_per_samples",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
