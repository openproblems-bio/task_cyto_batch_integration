// shuffle_integration_within_batch build_update_ilisi
// 
...
meta = [
  ...
  "description" : "This negative-control method randomly shuffles cells within each batch.\nCells lose their sample and cell type identity but remain in their original batch. \n\nExample: A cell from mouse 3 batch 1 may be reassigned to mouse 4 batch 1, \nbut not to another batch (e.g., mouse 6 batch 2).\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/control_methods/shuffle_integration_within_batch/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/control_methods/shuffle_integration_within_batch",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/control_methods/shuffle_integration_within_batch",
