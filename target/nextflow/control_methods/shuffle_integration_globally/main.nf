// shuffle_integration_globally build_update_ilisi
// 
...
meta = [
  ...
  "name" : "shuffle_integration_globally",
  ...
  "label" : "Shuffle Integration Globally",
  "summary" : "Randomly shuffle cells in the whole dataset.",
  "description" : "This negative control randomly shuffles all cells in the input data.\nCells lose all identity information (sample, batch, and cell type).\n\nExample: a cell from mouse 3 batch 1 may be reassigned to any sample in the data \n(mouse 4 batch 1 or mouse 6 batch 2).\n",
  "test_resources" : [
    {
      "type" : "python_script",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_cyto_batch_integration/task_cyto_batch_integration/src/control_methods/shuffle_integration_globally/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/control_methods/shuffle_integration_globally",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'output_integrated_split1': $( if [ ! -z ${VIASH_PAR_OUTPUT_INTEGRATED_SPLIT1+x} ]; then echo "r'${VIASH_PAR_OUTPUT_INTEGRATED_SPLIT1//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_integrated_split2': $( if [ ! -z ${VIASH_PAR_OUTPUT_INTEGRATED_SPLIT2+x} ]; then echo "r'${VIASH_PAR_OUTPUT_INTEGRATED_SPLIT2//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_cyto_batch_integration/control_methods/shuffle_integration_globally",
