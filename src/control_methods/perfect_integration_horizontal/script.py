...
par = {
    ...
    "output": "resources_test/task_cyto_batch_integration/mouse_spleen_flow_cytometry_subset/perfect_integration/output.h5ad",
}
meta = {"name": "perfect_integration_horizontal"}
## VIASH END
