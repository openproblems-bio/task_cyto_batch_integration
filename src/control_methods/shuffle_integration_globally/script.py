...
meta = {"name": "shuffle_integration_globally", "resources_dir": "src/control_methods"}
## VIASH END
...
integrated = _randomize_features(adata_split1.layers["preprocessed"])
...
integrated = _randomize_features(adata_split2.layers["preprocessed"])
# create new anndata
