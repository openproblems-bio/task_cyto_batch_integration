...
par = {
    # "input_integrated_split1": "/Users/putri.g/Documents/cytobenchmark/debug_emd/_viash_par/input_integrated_split1_1/human_cll_mass_cytometry.cycombine_all_controls_to_goal.cycombine_all_controls_to_goal.output.h5ad",
    # "input_integrated_split2": "/Users/putri.g/Documents/cytobenchmark/debug_emd/_viash_par/input_integrated_split2_1/human_cll_mass_cytometry.cycombine_all_controls_to_goal.cycombine_all_controls_to_goal.output.h5ad",
    # "input_unintegrated": "/Users/putri.g/Documents/cytobenchmark/debug_emd/_viash_par/input_unintegrated_1/unintegrated.h5ad",
    # "output": "/Users/putri.g/Documents/cytobenchmark/debug_emd/_viash_par/emd_out.h5ad",
...
print("Preprocessing input files", flush=True)
...
print("Sanity checking input files", flush=True)
# check that the data for each donor in split 1 and 2 are actually
...
print("Calculating horizontal EMD", flush=True)
# calculate horizontal EMD for each donor across split 1 and 2
